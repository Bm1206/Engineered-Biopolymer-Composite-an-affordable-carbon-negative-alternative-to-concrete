...
```
Using [LCA_Calculations.xlsx](LCA_Calculations.xlsx), we can compute the life cycle impacts associated with the manufacture of Engineered Biopolymer Composite (EBC). The 12 damage characterizations cover impacts related to climate change/carbon footprint, human health, and ecosystems. The values calculated here populate the remainder of Figure 4 in the manuscript. 
